...
; using a tweaked 32x24 CRTC configuration.
	...
	; Voy a definir como mè´°scara de los sprites el color 
...
;El tamaè´–o del buffer es ancho_pantalla_bytes*alto_pantalla_bytes
...
.posiciones_super_buffer
	;muestra el inicio de cada lè´ønea (son 10 tiles de 8x16 de alto)
