' rle44map_sp v0.1
' fbc rle44map_sp.bas cmdlineparser.bas mtparser.bas

#include "cmdlineparser.bi"
#include "mtparser.bi"

Dim Shared As uByte mainBin (65445)
Dim Shared As Integer mainIndex

Sub usage 
	Print "usage:"
	Print ""
	Print "rle44map_sp.exe in=map.map out=map.bin size=W,H [tlock=T]"
...
Print "rle44map_sp v0.1.20171019 ";
